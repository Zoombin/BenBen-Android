...
final class OrderCheckHandler extends Handler {

	private static final String TAG = OrderCheckHandler.class.getSimpleName();

	private final ActivityOrderCheck activity;
	private final MultiFormatReader multiFormatReader;
	private boolean running = true;

	OrderCheckHandler(ActivityOrderCheck activity, Map<DecodeHintType, Object> hints) {
