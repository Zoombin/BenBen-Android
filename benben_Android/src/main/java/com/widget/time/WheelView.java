...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xFF686868;

	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFFb4b4b4;
	...
	private void createLayouts(int widthItems, int widthLabel) {
		...
		if (!isScrollingPerformed
			...
			String text = getAdapter() != null ? getAdapter().getItem(
					currentItem) != null ? getAdapter().getItem(currentItem)
					: getAdapter().getItem(currentItem = 0) : null;
