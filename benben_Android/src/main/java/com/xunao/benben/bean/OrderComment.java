...
public class OrderComment extends BaseBean<OrderComment>{
	private int id;
	...
	@Override
	public OrderComment parseJSON(JSONObject jsonObj)
        ...
        try {
            ...
            if(jsonArray!=null && jsonArray.length()>0){
                for(int i=0;i<jsonArray.length();i++){
                    OrderCommentReply orderCommentReply = new OrderCommentReply();
                    orderCommentReply.parseJSON(jsonArray.getJSONObject(i));
                    orderCommentReplies.add(orderCommentReply);
                }
            }
    ...
    public ArrayList<OrderCommentReply> getOrderCommentReplies() {
        return orderCommentReplies;
    }
