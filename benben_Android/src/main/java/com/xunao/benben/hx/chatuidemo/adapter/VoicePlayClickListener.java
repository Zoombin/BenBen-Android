		...
		try {
			...
			mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
				...
				public void onCompletion(MediaPlayer mp) {
					...
					mediaPlayer.release();
					mediaPlayer = null;
                    ChatActivity.mSensorManager.unregisterListener(currentPlayListener.sensorEventListener);
//                    if(mSensorManager!=null) {
//                        Log.d("ltf","5==============unregisterListener");
//                        mSensorManager.unregisterListener(VoicePlayClickListener.this);
//                        mSensorManager = null;
//                        mSensor = null;
//                    }
...
//                if(mSensorManager!=null) {
//                    Log.d("ltf","2==============unregisterListener");
...
//                Log.d("ltf","3==============registerListener");
//                mSensorManager.registerListener(this, mSensor,
//                        SensorManager.SENSOR_DELAY_NORMAL);
//            }else{
//                playVoice(voiceBody.getLocalUrl(),1);
//            }
            ChatActivity.mSensorManager.registerListener(sensorEventListener, ChatActivity.mSensor,
                        SensorManager.SENSOR_DELAY_NORMAL);
		} else {
...
//        Log.d("ltf","6==================="+isPlaying);
//        if (range == ChatActivity.mSensor.getMaximumRange()) {
//            if (isPlaying) {
//                currentPlayListener.stopPlayVoice();
//            }
//            playVoice(voiceBody.getLocalUrl(),1);
////            }
//        } else {
//            Log.d("ltf","7==================="+isPlaying);
//            if (isPlaying) {
//                currentPlayListener.stopPlayVoice();
//            }
//            playVoice(voiceBody.getLocalUrl(),2);
////            }
//
//        }
//
