 ...
 */
package com.xunao.benben.hx.chatuidemo.db;
...
public class UserDao {
    ...
    public void setDisabledGroups(List<String> groups){
        ...
        if (db.isOpen()) {
            ContentValues values = new ContentValues();
            values.put(COLUMN_NAME_DISABLED_GROUPS, strBuilder.toString());
    ...
    public List<String>  getDisabledGroups(){
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery("select " + COLUMN_NAME_DISABLED_GROUPS + " from " + UserDao.PREF_TABLE_NAME,null);
    ...
    public void setDisabledIds(List<String> ids){
        ...
        if (db.isOpen()) {
            ContentValues values = new ContentValues();
            values.put(COLUMN_NAME_DISABLED_IDS, strBuilder.toString());
    ...
    public List<String> getDisabledIds(){
        SQLiteDatabase db = dbHelper.getReadableDatabase();
        Cursor cursor = db.rawQuery("select " + COLUMN_NAME_DISABLED_IDS + " from " + UserDao.PREF_TABLE_NAME,null);
        if (!cursor.moveToFirst()) {
            cursor.close();
            return null;
        }
