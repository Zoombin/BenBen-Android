 ...
 */
package com.xunao.benben.hx.chatuidemo.task;
...
//					.getLayoutParams();
//			if (image != null) {
//				layoutParams.width = (int) ( image.getWidth() * PixelUtil.getScale());
//				layoutParams.height = (int) (image.getHeight()* PixelUtil.getScale());
//			}
//
