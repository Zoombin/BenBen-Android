 ...
 */
package com.xunao.benben.hx.chatuidemo.utils;
...
public class CameraHelper implements PreviewCallback {
    ...
    boolean isScreenOriatationPortrait() {
        return CrashApplication.applicationContext.getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
