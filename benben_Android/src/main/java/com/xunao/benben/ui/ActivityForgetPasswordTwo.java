...
public class ActivityForgetPasswordTwo extends BaseActivity implements
		OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.com_title_bar_right_tv:
			if(input_phone_code.getText().toString().equals(phone_code)){
				startAnimActivity2Obj(ActivityForgetPasswordThree.class, "phone", phone_num, "code", phone_code);
			}else{
