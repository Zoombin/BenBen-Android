...
public class ActivityGroupBuyDetail extends BaseActivity {
	...
	public void initDate(Bundle savedInstanceState) {
        ...
        webView.loadUrl( AndroidConfig.NETHOST+"/groupBuy/groupbuyDetail/key/android?promotionid="+promotionId[position]);
                ...
                switch (index) {
                    case 0:
                        if(CommonUtils.isNetworkAvailable(mContext)){
                            InteNetUtils.getInstance(mContext).AddCollect(promotionId[position],"1",mRequestCallBack);
                        }else{
...
//                        break;
                    ...
                    case 1:
                        Intent intent = new Intent(ActivityGroupBuyDetail.this, ActivityShareSelectFriend.class);
                        intent.putExtra("url",AndroidConfig.NETHOST+"/groupBuy/groupbuyDetail/key/android?promotionid="+promotionId[position]);
                        startActivity(intent);
                        overridePendingTransition(R.anim.in_from_right, R.anim.out_to_left);
                        break;
                    case 2:
                        Intent groupintent = new Intent(ActivityGroupBuyDetail.this, ActivityShareSelectTalkGroup.class);
                        groupintent.putExtra("url",AndroidConfig.NETHOST+"/groupBuy/groupbuyDetail/key/android?promotionid="+promotionId[position]);
	...
	private class MyWebClinet extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            if(url.contains("www.baidu.com")){
                    ...
                    startActivity(intent);
                    overridePendingTransition(R.anim.in_from_right, R.anim.out_to_left);
            }else if(url.contains("storeComment")){
                view.loadUrl(url);
            }else {
                position++;
