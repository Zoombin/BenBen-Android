...
public class ActivityChoiceBroadCastFriendByArea extends BaseActivity implements
		OnClickListener {
	...
	protected ArrayList<Contacts> groupContacts = new ArrayList<Contacts>();
	...
	public void initDate(Bundle savedInstanceState) {
		selectedContacts = (ArrayList<Contacts>) getIntent().getSerializableExtra("selectContacts");
		if (CommonUtils.isNetworkAvailable(mContext)) {
			InteNetUtils.getInstance(mContext).getFriendByArea(null,
					mRequestCallBack);
		}
	}
	...
	public void initLinstener(Bundle savedInstanceState) {
		setOnLeftClickLinester(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.putExtra("result", AndroidConfig.CLOSE);
	...
	protected void onActivityResult(int arg0, int arg1, Intent arg2) {
		...
		case CHOCE_ADDRESS:
			if (arg2 != null) {
				...
				InteNetUtils.getInstance(mContext).getFriendByArea(addressId,
						mRequestCallBack);
				tv_list.setText(getSelectName());
				tv_listnum.setText(getSelectNum());
			}
			...
			convertView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					if (checkBox.isChecked()) {
						...
						if (groupContacts.size() >= contactsList.size()) {
							all_checkbox.setOnCheckedChangeListener(null);
							all_checkbox.setChecked(true);
							all_checkbox
									.setOnCheckedChangeListener(changeListener);
