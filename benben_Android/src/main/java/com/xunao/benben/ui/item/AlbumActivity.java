...
import com.xunao.benben.base.adapter.AlbumGridViewAdapter;
...
public class AlbumActivity extends Activity {
	...
	private void init() {
		...
		// back = (MyTextView) findViewById(Res.getWidgetID("back"));
		cancel = (ImageView) findViewById(Res.getWidgetID("cancel"));
		activity_selectimg_send = (TextView) findViewById(Res.getWidgetID("activity_selectimg_send"));
		
		activity_selectimg_send.setOnClickListener(new BackListener());
