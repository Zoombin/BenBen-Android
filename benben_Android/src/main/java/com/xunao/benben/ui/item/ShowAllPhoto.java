...
//	private Button cancel;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = this;
		back = (ImageView) findViewById(Res.getWidgetID("plugin_camera_title_btn_back"));
...
//			Bimp.tempSelectBitmap.clear();
	...
	private class CancelListener implements OnClickListener {// 取消按钮的监听
		public void onClick(View v) {
			// 清空选择的图片
			Bimp.tempSelectBitmap.clear();
			intent.setClass(mContext, ActivityWriteFriend.class);
			startActivity(intent);
		}
	}
					...
					public void onItemClick(final ToggleButton toggleButton,
                        ...
                        try {
                            bitmap = new SoftReference<Bitmap>(
                                    Bimp.revitionImageSize(dataList.get(position).getImagePath()));
                        } catch (IOException e) {
