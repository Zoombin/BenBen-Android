 ...
 */
public class ActivityMyOrderComment extends BaseActivity implements View.OnClickListener {
    private Order order;
        ...
        switch (view.getId()){
            ...
            case R.id.btn_comment:
                ...
                if(CommonUtils.isNetworkAvailable(mContext)){
                    InteNetUtils.getInstance(mContext).Ordercomment(order.getPromotion_id(),order.getOrder_id(),1,content,comment_rank, mRequestCallBack);
                }else{
