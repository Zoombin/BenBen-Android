...
public class VoicelistMyPlayClickListener implements View.OnClickListener {

	MySmallCreationData samllData;
	File voiceFile;
	...
	public static VoicelistMyPlayClickListener currentPlayListener = null;
	 ...
	 * @param chatType
	 */
	public VoicelistMyPlayClickListener(MySmallCreationData samllData, ImageView v,
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((ActivityMySmallMake) activity).playMsgId = null;
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			...
			if (currentPlayListener == VoicelistMyPlayClickListener.this) {
				return;
			}
		}
