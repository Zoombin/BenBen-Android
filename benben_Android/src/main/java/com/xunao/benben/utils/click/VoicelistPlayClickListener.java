...
public class VoicelistPlayClickListener implements View.OnClickListener {

	SmallMakeData samllData;
	File voiceFile;
	...
	public static VoicelistPlayClickListener currentPlayListener = null;
	 ...
	 * @param chatType
	 */
	public VoicelistPlayClickListener(SmallMakeData samllData, ImageView v,
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			...
			if (currentPlayListener == VoicelistPlayClickListener.this) {
				return;
			}
		}
