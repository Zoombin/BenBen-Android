...
public class ActionSheet extends Fragment implements OnClickListener {
	...
	// btn tiltle color
	private static final String ARG_OTHER_BUTTON_TITLES_COLOR = "other_button_titles_color";
	...
	private static boolean ishowing = false;
	...
	private void createItems() {
		...
		String[] titlesColor = getOtherButtonTitlesColor();
	...
	private String[] getOtherButtonTitlesColor() {
		return getArguments().getStringArray(ARG_OTHER_BUTTON_TITLES_COLOR);
	}
	...
	public static class Builder {
		...
		private String[] mOtherButtonTitlesColor;
		...
		public Builder setOtherButtonTitlesColor(String... titleColor) {
			mOtherButtonTitlesColor = titleColor;
			return this;
		}
		...
		public Bundle prepareArguments() {
			...
			bundle.putStringArray(ARG_OTHER_BUTTON_TITLES_COLOR,
					mOtherButtonTitlesColor);
