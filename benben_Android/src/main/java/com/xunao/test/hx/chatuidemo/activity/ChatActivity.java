 ...
 */
package com.xunao.test.hx.chatuidemo.activity;
...
import com.xunao.test.bean.NumberTrain;
...
import com.xunao.test.hx.chatuidemo.adapter.ExpressionAdapter;
import com.xunao.test.hx.chatuidemo.adapter.ExpressionPagerAdapter;
import com.xunao.test.hx.chatuidemo.adapter.MessageAdapter;
import com.xunao.test.hx.chatuidemo.adapter.VoicePlayClickListener;
import com.xunao.test.hx.chatuidemo.utils.CommonUtils;
import com.xunao.test.hx.chatuidemo.utils.ImageUtils;
import com.xunao.test.hx.chatuidemo.utils.SmileUtils;
import com.xunao.test.hx.chatuidemo.widget.ExpandGridView;
import com.xunao.test.hx.chatuidemo.widget.PasteEditText;
import com.xunao.test.net.InteNetUtils;
import com.xunao.test.ui.ActivityNumberTrain;
import com.xunao.test.ui.item.ActivityContactsInfo;
import com.xunao.test.ui.item.ImageFile;
import com.xunao.test.ui.item.TallGroup.ActivityGroupNoticeDetails;
import com.xunao.test.ui.item.TallGroup.ActivityTalkGroupInfo;
import com.xunao.test.ui.shareselect.ActivityShareSelectFriend;
import com.xunao.test.ui.shareselect.ActivityShareSelectTalkGroup;
				...
				try {
					...
					if (buttonSetModeKeyboard.getVisibility() != View.VISIBLE) {
						...
						if (filename != "delete_expression") { // 不是删除键，显示表情
							...
							Class clz = Class
									.forName("com.xunao.test.hx.chatuidemo.utils.SmileUtils");
