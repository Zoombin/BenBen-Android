...
import com.xunao.test.hx.chatuidemo.video.util.Utils;
...
//			camParams.setFlashMode(Parameters.FLASH_MODE_TORCH);
	...
	public void onClick(View view) {
		...
		case R.id.recorder_stop:
			...
			final InfoMsgHint hint = new InfoMsgHint(
					RecorderVideoActivity.this, R.style.MyDialog1);
			hint.setContent("确定发送视频?", "", "确定", "取消");
	...
	private void showFailDialog() {
		...
		String st6 = getResources().getString(
				R.string.Open_the_equipment_failure);
		new AlertDialog.Builder(this)
				.setTitle(st5)
				.setMessage(st6)
				.setPositiveButton(R.string.ok,
