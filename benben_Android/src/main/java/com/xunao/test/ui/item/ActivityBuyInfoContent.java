...
import com.xunao.test.bean.BuyInfoContent;
import com.xunao.test.bean.QuoteContent;
import com.xunao.test.bean.SuccessMsg;
import com.xunao.test.config.AndroidConfig;
import com.xunao.test.dialog.BuyDialog;
import com.xunao.test.dialog.InfoMsgHint;
import com.xunao.test.dialog.MsgDialog;
import com.xunao.test.dialog.BuyDialog.onSuccessLinstener;
