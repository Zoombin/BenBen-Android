...
import com.xunao.test.bean.BroadCasting;
import com.xunao.test.bean.SmallMakeData;
import com.xunao.test.ui.item.ActivitySmallPublics;
import com.xunao.test.utils.CommonUtils;

import java.io.File;

public class VoiceCastPlayClickListener implements View.OnClickListener {

    BroadCasting samllData;
	File voiceFile;
	...
	public static VoiceCastPlayClickListener currentPlayListener = null;
	 ...
	 * @param activity
	 */
	public VoiceCastPlayClickListener(BroadCasting samllData, ImageView v,
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		((ActivitySmallPublics) activity).playMsgId = null;
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			...
			if (currentPlayListener == VoiceCastPlayClickListener.this) {
				return;
			}
		}
