...
import com.xunao.test.bean.SmallMakeSingleData;
...
public class VoicelistSinglePlayClickListener implements View.OnClickListener {
	 ...
	 * @param chatType
	 */
	public VoicelistSinglePlayClickListener(SmallMakeSingleData samllData,
			ImageView v, View error, View loding, Activity activity) {
	...
	public VoicelistSinglePlayClickListener(MySmallCreationData item,
			ImageView item_friend_voice, View item_friend_voice_error,
			View item_friend_voice_loding, BaseActivity mContext) {
	...
	public void stopPlayVoice() {
		...
		isPlaying = false;
		if (activity instanceof ActivitySmallMake)
	...
	public void onClick(View v) {
		...
		if (isPlaying) {
			...
			if (currentPlayListener == VoicelistSinglePlayClickListener.this) {
				return;
			}
		}
